# Indent + AWS Lambda and OpsGenie

This repository contains an integration between OpsGenie and [Indent](https://indent.com). Once deployed, you will be able to use this integration with Indent to:
...
Visit <a href="https://indent.com/docs/integrations/opsgenie" target="_blank">this link</a> to our documentation for information on setting up GitHub Secrets in this repository.
